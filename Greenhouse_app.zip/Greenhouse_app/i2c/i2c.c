	...
	if(i2c == I2C0)
	{
		switch(alt)
		{
			...
			case ALT3:
				...
				PORTC_PCR8 = PORT_PCR_MUX(0x2);    		//Set PTC8 to mux 2 [I2C_SCL]
				PORTC_PCR9 = PORT_PCR_MUX(0x2);    		//Set PTC9 to mux 2 [I2C_SDA]
			break;
...
void i2c_WriteText(I2C_MemMapPtr i2c, uint8_t SlaveAddress, uint8_t n_data, uint8_t *data)
{
	uint8_t i = 0;
